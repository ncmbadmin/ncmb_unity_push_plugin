...
namespace  NCMB
{
	...
	/// </summary>
	[NCMBClassName ("currentInstallation")]
	public class NCMBCurrentInstallation : NCMBInstallation
	{
		...
		/// </summary>
		internal NCMBCurrentInstallation (string jsonText): base () //NCMBInstallationのコンストラクタ実行
		{
		...
		/// </summary>
		public NCMBCurrentInstallation () : this ("")
		{
		}
		...
		public static void GetDeviceToken(NCMBCurrentInstallation installation, NCMBGetCallback<String> callback){
		...
		public static NCMBCurrentInstallation getCurrentInstallation ()
		{
			NCMBCurrentInstallation currentInstallation = null;
			try {
				...
				if (currentInstallationData != "") {
					//ローカルファイルから端末情報を取得
					currentInstallation = new NCMBCurrentInstallation (currentInstallationData);
				} else {
					currentInstallation = new NCMBCurrentInstallation ();
				}
